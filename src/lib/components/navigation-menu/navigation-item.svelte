...
<a href={navLink.link} class="flex flex-row items-center gap-2 rounded-md px-4 py-2 hover:bg-secondary w-full" class:bg-primary-foreground={!active} class:bg-secondary={active}>
  {#if navLink.icon}
